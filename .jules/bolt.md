...
## 2024-05-24 - asdict Overhead in Dataclasses
...
**Action:** Replace `asdict` with manual dictionary creation (e.g., `{'kind': self.kind, ...}`) in hot loops, which is significantly faster.
