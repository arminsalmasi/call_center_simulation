...
## 2024-05-24 - EAFP over LBYL in statistical aggregators
**Learning:** In this codebase's statistical aggregators, eager checking (LBYL) and repeated dictionary lookups in hot loops introduce significant execution overhead.
**Action:** Use the EAFP pattern (`try...except KeyError`) and assign nested dictionaries to local variables to minimize dictionary accesses.
