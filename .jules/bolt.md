...
## 2024-05-24 - Optimize dictionary lookups in statistical aggregators
**Learning:** In this codebase's statistical aggregators (e.g., `CallStatistics`), eagerly checking dictionary keys (`if key not in dict`) and performing multiple nested lookups creates a significant overhead.
