...
class CallStatistics:
    ...
    def add_fresher_call(self, index, call_duration):
        ...
        """
        # Bolt performance optimization: Use EAFP pattern and local variable assignment
        # to reduce redundant dictionary lookups in this hot loop.
        try:
...
def main():
    ...
    try:
        ...
        if args.min_sleep_interval <= 0:
            parser.error("min_sleep_interval must be strictly positive to prevent CPU spinning")
