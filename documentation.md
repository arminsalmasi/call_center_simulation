...
This function finds an available fresher employee in the call center. It expects an iterable of booleans. It returns the index of the first available fresher, or -1 if no freshers are available.
